...
participants = ['e45', 'e46', 'e47', 'e48', 'e49']
...
for participant in participants:
    ...
    directory = '/Users/ghislaindentremont/Documents/Experiments/Multimodal_IOR/Ghis/P_analysis_topo_AR/%s' % participant
    ...
    evoked_left_cued_TT = get_topo( raw, {'LT/LT': 25}, np.arange(.060, .120, .010), 0.005, tmin, tmax, reject_num = 100e-6, AR = True )
    evoked_right_cued_TT = get_topo(raw, {'RT/RT': 35}, np.arange(.060, .120, .010), 0.005, tmin, tmax, reject_num=100e-6, AR=True)

    evoked_left_uncued_TT = get_topo( raw, {'RT/LT': 33}, np.arange(.060, .120, .010), 0.005, tmin, tmax, reject_num = 100e-6, AR = True )
    evoked_right_uncued_TT = get_topo( raw, {'LT/RT': 27}, np.arange(.060, .120, .010), 0.005, tmin, tmax, reject_num = 100e-6, AR = True )
...
directory = '/Users/ghislaindentremont/Documents/Experiments/Multimodal_IOR/Ghis/P_analysis_topo_AR'
...
avg_left_red_TT.plot_topomap([.090], ch_type='eeg', show_names=True, average= 0.030, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_left_red_TT.plot_topomap(np.arange(.060, .130, .010), ch_type='eeg', show_names=True, average= 0.005, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_right_red_TT.plot_topomap([.090], ch_type='eeg', show_names=True, average= 0.030, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_right_red_TT.plot_topomap(np.arange(.060, .130, .010), ch_type='eeg', show_names=True, average= 0.005, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_left_red_VT.plot_topomap([.090], ch_type='eeg', show_names=True, average= 0.030, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_left_red_VT.plot_topomap(np.arange(.060, .130, .010), ch_type='eeg', show_names=True, average= 0.005, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_right_red_VT.plot_topomap([.090], ch_type='eeg', show_names=True, average= 0.030, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_right_red_VT.plot_topomap(np.arange(.060, .130, .010), ch_type='eeg', show_names=True, average= 0.005, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_left_red_TV.plot_topomap([.120], ch_type='eeg', show_names=True, average= 0.050, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_left_red_TV.plot_topomap(np.arange(.070, .180, .010), ch_type='eeg', show_names=True, average= 0.005, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_right_red_TV.plot_topomap([.120], ch_type='eeg', show_names=True, average= 0.050, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_right_red_TV.plot_topomap(np.arange(.070, .180, .010), ch_type='eeg', show_names=True, average= 0.005, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_left_red_VV.plot_topomap([.120], ch_type='eeg', show_names=True, average= 0.050, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_left_red_VV.plot_topomap(np.arange(.070, .180, .010), ch_type='eeg', show_names=True, average= 0.005, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_right_red_VV.plot_topomap([.120], ch_type='eeg', show_names=True, average= 0.050, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
...
avg_right_red_VV.plot_topomap(np.arange(.070, .180, .010), ch_type='eeg', show_names=True, average= 0.005, vmin=-3, vmax=3)
fig = plt.gcf()
fig.set_size_inches(18.5, 10.5)
